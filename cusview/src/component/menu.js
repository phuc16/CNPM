  ...
  const handleCancel = () => {
    ...
    <div  class="card-group">
        <Card style={{ 'margin': "20px 20px 20px 120px" }}>
            <img class="card-img-top" src={'img/pizza1.jpeg'} style={{ 'border-radius': "10px" }} alt=''></img>
            <Card.Body>
        ...
        <Card style={{ 'margin': "20px 20px 20px 0px" }}>
            <img class="card-img-top" src={'img/pizza2.webp'} style={{ 'border-radius': "10px" }} alt=''></img>
            <Card.Body>
        ...
        <Card style={{ 'margin': "20px 20px 20px 0px" }}>
            <img class="card-img-top" src={'img/pizza3.png'} style={{ 'border-radius': "10px" }} alt=''></img>
            <Card.Body>
        ...
        <Card style={{ 'margin': "20px 120px 20px 0px" }}>
            <img class="card-img-top" src={'img/pizza4.jpg'} style={{ 'border-radius': "10px" }} alt=''></img>
            <Card.Body>
